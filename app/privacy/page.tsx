...
const page = () => {
	return (
		<div className="max-w-3xl mx-auto bg-white p-4 rounded-lg shadow-md mt-24 mb-24">
			<h1 className="text-2xl mb-4 mt-6">Privacy Policy for Melios</h1>

			<p>
				At Melios, accessible from https://melios.me, one of our main priorities is
				the privacy of our visitors. This Privacy Policy document contains types of
				information that is collected and recorded by Melios and how we use it.
			</p>
			...
			<h2 className="text-xl mb-4 mt-6">Log Files</h2>

			<p>
				Melios follows a standard procedure of using log files. These files log
			...
			<p>
				Like any other website, Melios uses "cookies". These cookies are used to
			...
			<h2 className="text-xl mb-4 mt-6">Privacy Policies</h2>

			<p>
				You may consult this list to find the Privacy Policy for each of the
				advertising partners of Melios.
			</p>

			<p>
				Third-party ad servers or ad networks uses technologies like cookies,
				JavaScript, or Web Beacons that are used in their respective advertisements
				and links that appear on Melios, which are sent directly to users' browser.
			...
			<p>
				Note that Melios has no access to or control over these cookies that are
				used by third-party advertisers.
			</p>

			<h2 className="text-xl mb-4 mt-6">Third Party Privacy Policies</h2>

			<p>
				Melios's Privacy Policy does not apply to other advertisers or websites.
			...
			<h2 className="text-xl mb-4 mt-6">Children's Information</h2>
			...
			<p>
				Melios does not knowingly collect any Personal Identifiable Information from
			...
			<h2 className="text-xl mb-4 mt-6">Online Privacy Policy Only</h2>

			<p>
				This Privacy Policy applies only to our online activities and is valid for
				visitors to our website with regards to the information that they shared
				and/or collect in Melios. This policy is not applicable to any information
				collected offline or via channels other than this website.
			</p>

			<h2 className="text-xl mb-4 mt-6">Consent</h2>
