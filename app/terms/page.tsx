...
const page = () => {
	return (
		<div className="max-w-3xl mx-auto bg-white p-4 rounded-lg shadow-md mt-24 mb-24">
			<h2 className="text-2xl mb-4 mt-6">Terms and Conditions</h2>
			<p>Last updated: May 17, 2024</p>
			<p>
				Please read these terms and conditions carefully before using Our Service.
			</p>
			<h2 className="text-2xl mb-4 mt-6">Interpretation and Definitions</h2>
			...
			<ul>
				...
				<li>
					<p>
						...
						<a
							href="https://melios-web.vercel.app/"
							rel="external nofollow noopener"
							target="_blank"
						>
							https://melios-web.vercel.app/
						</a>
					</p>
				</li>
				<li>
			...
			<h2 className="text-2xl mb-4 mt-6">Acknowledgment</h2>
			<p>
			...
			<h2 className="text-2xl mb-4 mt-6">Links to Other Websites</h2>
			<p>
			...
			<h2 className="text-2xl mb-4 mt-6">Termination</h2>
			<p>
			...
			<h2 className="text-2xl mb-4 mt-6">Limitation of Liability</h2>
			<p>
			...
			<h2 className="text-2xl mb-4 mt-6">Governing Law</h2>
			<p>
			...
			<h2 className="text-2xl mb-4 mt-6">Disputes Resolution</h2>
			<p>
			...
			<h2 className="text-2xl mb-4 mt-6">United States Legal Compliance</h2>
			<p>
			...
			<h2 className="text-2xl mb-4 mt-6">Severability and Waiver</h2>
			<h3 className="text-xl mb-4 mt-6">Severability</h3>
			<p>
			...
			<h3 className="text-xl mb-4 mt-6">Waiver</h3>
			<p>
