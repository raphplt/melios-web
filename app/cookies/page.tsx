...
const page = () => {
	return (
		<div className="max-w-3xl mx-auto bg-white p-4 rounded-lg shadow-md mt-24 mb-24">
			<h1 className="text-2xl mb-4 mt-6">Cookie Policy</h1>
			<p>Last updated: March 3, 2024</p>
			<p>
				This Cookie Policy explains what cookies are and how we use them. You should
				read this policy to understand the types of cookies we use, the information
				we collect using cookies, and how that information is used.
			</p>
			<p>
				Cookies generally do not contain any information that personally identifies
				a user, but personal information that we store about you may be linked to
				the information stored in and obtained from cookies. For more information on
				how we use, store, and keep your personal data secure, see our Privacy
				Policy.
			</p>
			<p>
			...
			<h1 className="text-xl mb-4 mt-6">Interpretation and Definitions</h1>
			<h2>Interpretation</h2>
			<p>
				Words with the initial letter capitalized have defined meanings under the
			...
			<ul>
				<li>
					...
					or "Our" in this Cookie Policy) refers to Melios.
				</li>
				<li>
			...
			<h1 className="text-xl mb-4 mt-6">The Use of Cookies</h1>
			...
			<h2 className="text-xl mb-4 mt-6">Your Choices Regarding Cookies</h2>
			<p>
				If you prefer to avoid the use of cookies on the Website, you must first
				disable the use of cookies in your browser, then delete the cookies saved in
			...
			<p>
				If you want to delete cookies or instruct your web browser to delete or
			...
			<h2 className="text-xl mb-4 mt-6">Contact Us</h2>
			<p>
