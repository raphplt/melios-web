...
<div>
	...
	<div class="max-w-3xl mx-auto bg-white p-4 rounded-lg shadow-md mt-24 mb-24">
		...
		<h2 class="text-xl mb-4 mt-6">Log Files</h2>

		<p>
			Melios follows a standard procedure of using log files. These files log visitors when they
		...
		<p>
			Like any other website, Melios uses "cookies". These cookies are used to store information
		...
		<h2 class="text-xl mb-4 mt-6">Privacy Policies</h2>
		...
		<p>
			...
			Beacons that are used in their respective advertisements and links that appear on Melios,
		...
		<p>
			Note that Melios has no access to or control over these cookies that are used by third-party
			advertisers.
		</p>

		<h2 class="text-xl mb-4 mt-6">Third Party Privacy Policies</h2>

		<p>
			Melios's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising
		...
		<h2 class="text-xl mb-4 mt-6">Children's Information</h2>
		...
		<p>
			Melios does not knowingly collect any Personal Identifiable Information from children under
			the age of 13. If you think that your child provided this kind of information on our website,
			we strongly encourage you to contact us immediately and we will do our best efforts to
			promptly remove such information from our records.
		</p>

		<h2 class="text-xl mb-4 mt-6">Online Privacy Policy Only</h2>

		<p>
			This Privacy Policy applies only to our online activities and is valid for visitors to our
			website with regards to the information that they shared and/or collect in Melios. This policy
			is not applicable to any information collected offline or via channels other than this
			website.
		</p>

		<h2 class="text-xl mb-4 mt-6">Consent</h2>
